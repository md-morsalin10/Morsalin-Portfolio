...
const cards = [
  ...
  { icon: '📍', label: 'Location',       val: 'Rangpur, Bangladesh'     },
...
function StatBadge({ num, label, delay }) {
  return (
    <motion.div variants={fadeUp(delay)} className="flex flex-col items-center gap-1">
      <motion.span
  ...
  return (
    <section id="about" className="relative py-28 px-6 bg-[#060412] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="h-px flex-1 max-w-12 bg-gradient-to-r from-transparent to-violet-500/50" />
            ...
            <motion.div variants={fadeUp(0)}>
              <TiltCard className="relative w-64 h-72 md:w-72 md:h-80">
                ...
                <motion.div
                  ...
                  style={{ background: 'conic-gradient(from 0deg,#7c3aed,#a855f7,#c084fc,transparent,#7c3aed)' }}
                  animate={{ rotate: 360 }}
          ...
          >
            ...
            >
              {cards.map((c) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.03, borderColor: 'rgba(168,85,247,.35)', backgroundColor: 'rgba(139,92,246,.08)', y: -2 }}
                  className="p-4 rounded-2xl border border-white/6 bg-white/4 cursor-default group"
                >
            ...
            <motion.div variants={fadeUp(0.45)} className="mt-10 flex gap-3 flex-wrap">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="relative px-7 py-3 rounded-xl font-bold text-[14px] text-white overflow-hidden group"
              >
                <motion.span
